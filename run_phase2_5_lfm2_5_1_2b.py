#!/usr/bin/env python3
"""
Phase 5 — Full Fine-Tuning: LFM2.5-1.2B-Instruct

Full parameter fine-tuning (no LoRA/QLoRA) of LiquidAI/LFM2.5-1.2B-Instruct.
Saves complete model weights to ./models/lfm2_5_1_2b_finetuned/

Run in background:
    nohup python run_phase5.py > logs/phase5_lfm2_5_1_2b.log 2>&1 &

Monitor:
    tail -f logs/phase5_lfm2_5_1_2b.log
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("logs/phase5_lfm2_5_1_2b.log", mode="a"),
    ],
)
...
CONFIG = {
    ...
    "OUTPUT_DIR":            Path("./models/lfm2_5_1_2b_finetuned"),
    "DATA_DIR":              Path("."),
...
def build_sft_config(cfg: dict) -> SFTConfig:
    return SFTConfig(
        ...
        gradient_checkpointing       = True,    # FIXED: Enable for 1.2B model
        learning_rate                = cfg["LEARNING_RATE"],
        weight_decay                 = cfg["WEIGHT_DECAY"],
        warmup_ratio                 = cfg["WARMUP_RATIO"],
        lr_scheduler_type            = cfg["LR_SCHEDULER"],
        optim                        = "adamw_torch_fused",  # FIXED: Add _fused for stability
        bf16                         = True,
        fp16                         = False,
...
def main():
    ...
    if hf_token:
        ...
        log.warning("HF_TOKEN not set — may fail if LFM2.5-1.2B-Instruct is gated")
    ...
    log.info("\n" + "="*65)
    log.info("  PHASE 5 — Full Fine-Tuning: LFM2.5-1.2B-Instruct")
